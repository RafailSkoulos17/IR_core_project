...
data ="C:\\Users\\Kon\\Desktop\\IR_core_project-master\\index_inputs\\hierarchical_index.trectext"

schema = Schema(title=TEXT(stored=True), content=TEXT, doc=ID(stored=True))  # Define schema
...
with open(data, "r", encoding="utf8") as f:
        for line in f.readlines():
            if line.startswith("</TEXT>"):
                ...
                writer.add_document(title=headline,content=new_text,doc=docno)
